...
function main() {
    var todos = [
        ...
        {
            task: 'Dodany TODOS nie pojawia się po prostu a wyjeżdża w dowolnej animacji',
            isCompleted: true
        },
        {
            task: 'Przycisk edycji TODOSA (text zmienia się w input, przycisk edycji w zatwierdzenie), zmieniamy i zapisujemy konkretnego todosa ',
            isCompleted: true
        },
        {
            task: 'Usuwanie todosa, również z animacją',
            isCompleted: true
        },
        {
            task: 'Pusta lista wyświetla informacje "Brak zadań"',
            isCompleted: true
        }
    ...
    var app = {
        ...
        showTodos: function() {
            ...
            todos.forEach(function(todo){
                var taskClasses = 'todo-task';
                if(todo.isCompleted) {
                    taskClasses += ' is-completed';
                }
